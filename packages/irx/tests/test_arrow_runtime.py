...
EXPECTED_ARROW_ABI_VERSION = 0x00010500
ARROW_STATUS_OK = 0
...
def test_arrow_runtime_reports_stable_abi_and_feature_versions() -> None:
    ...
    result = _compile_arrow_harness(
        ...
        int main(void) {
          ...
          if (IRX_ARROW_ABI_VERSION_MINOR != 5) return 12;
          ...
          if (available != 1 || supported != UINT32_C(0x00010500)) {
            return 16;
          }
          ...
          if (available != 0 || supported != UINT32_C(0x00010500)) {
            return 19;
          }
