...
EXPECTED_ARROW_ABI_VERSION = 0x00010600
ARROW_STATUS_OK = 0
...
def test_arrow_runtime_reports_stable_abi_and_feature_versions() -> None:
    ...
    result = _compile_arrow_harness(
        ...
        #if IRX_ARROW_ABI_VERSION != UINT32_C(0x00010600)
        ...
        int main(void) {
          ...
          if (IRX_ARROW_ABI_VERSION_MINOR != 6) return 12;
          ...
          if (available != 1 || supported != UINT32_C(0x00010600)) {
            return 16;
          }
          ...
          if (available != 0 || supported != UINT32_C(0x00010600)) {
            return 19;
          }
